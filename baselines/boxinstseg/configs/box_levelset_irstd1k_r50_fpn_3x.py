...
DATA_ROOT = os.path.join(PROJECT_ROOT, "dataset", "IRSTD-1k", "boxinstseg_coco") + "/"
WORK_DIR = os.path.join(PROJECT_ROOT, "baselines", "boxinstseg", "work_dirs", "box_levelset_irstd1k_r50_fpn_3x")
CLASSES = ("target",)
