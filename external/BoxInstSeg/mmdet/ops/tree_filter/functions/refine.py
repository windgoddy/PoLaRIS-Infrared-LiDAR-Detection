...
try:
    ...
    class MockTreeFilterCuda:
        @staticmethod
        def refine_forward(feature_in, edge_weight, sorted_index, sorted_parent, sorted_child):
            return feature_in, feature_in, feature_in, edge_weight, edge_weight
        @staticmethod
        def refine_backward(grad_output, feature_in, edge_weight, sorted_index, sorted_parent, sorted_child):
