...
try:
    ...
    print("Warning: roi_align import failed, using fallback")
    def roi_align(input, boxes, output_size, spatial_scale=1.0, sampling_ratio=-1, pool_mode='avg', aligned=True):
        return input
